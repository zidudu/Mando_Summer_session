...
# ── 파일 경로 (수정하세요) ─────────────────────────
LOG_CSV  = "/home/jigu/catkin_ws/src/rtk_waypoint_tracker/config/waypoint_log_20250903_182510.csv"
WPT_CSV  = "/home/jigu/catkin_ws/src/rtk_waypoint_tracker/config/left_lane.csv"
...
def main():
    ...
    xs = log_df["current_x"].values
    ys = log_df["current_y"].values
