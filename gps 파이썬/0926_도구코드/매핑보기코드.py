...
# ---------------- 사용자 설정 ----------------
WPT_CSV  = "/home/jigu/catkin_ws/src/rtk_waypoint_tracker/config/u-center-GMap_v2_0921_ORIG_byWP_0067_0105.csv"
OUT_PNG  = os.path.splitext(os.path.basename(WPT_CSV))[0] + "_waypoints.png"

# 표시/분석 파라미터
WAYPOINT_SPACING   = 2.0   # [m] 재샘플링 간격 (0 이면 원래 포인트 그대로 사용)
