...
def main():
    ...
    # 파라미터
    csv_path    = rospy.get_param('~csv_path',    os.path.expanduser('/home/jigu/catkin_ws/src/rtk_waypoint_tracker/config/raw_track_latlon_18.csv'))
    ...
    steering_pub = rospy.Publisher('/filtered_steering_angle1', Float32, queue_size=10)
    waypoint_index_pub = rospy.Publisher('/current_waypoint_index1', Int32, queue_size=10, latch=True)
